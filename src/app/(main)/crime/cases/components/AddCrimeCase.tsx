...
interface AddCrimeCaseProps {
  userBarangayId?: number; // For barangay_admin - locks barangay selection
}

export default function AddCrimeCase({ userBarangayId }: AddCrimeCaseProps) {
  const [step, setStep] = useState(0);

  const crimeCaseMutation = useCreateCrimeCase();

  // Use userBarangayId as default if provided (for barangay_admin)
      ...
      <DialogContent className="max-h-[30rem] w-full overflow-y-scroll">
        <Form {...form}>
          ...
          >
            ...
            {step === 2 && (
              <LocationInformation lockedBarangayId={userBarangayId} />
            )}
